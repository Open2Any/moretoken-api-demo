#!/usr/bin/env python3
"""Test Qwen HappyHorse 1.0 text-to-video via the moretoken gateway."""

# ---- hardcoded config ----
API_KEY = "API_KEY"
BASE_URL = "https://napi.moretoken.ai"
MODEL = "happyhorse-1.0-t2v"
PROMPT = "清晨海边的真实自拍视频风格，一位年轻女生站在海风中轻轻转身，抬手整理头发，阳光从云层洒下，浪花在身后翻涌，镜头轻微手持晃动，画面清晰自然，动作连贯。"
RESOLUTION = "720P"
SECONDS = 15
WATERMARK = True
SEED = None
...
OUTPUT_FILE = "../assets/output/qwen/output_qwen_happyhorse_1_0_t2v_video_generation_15s.mp4"
...
def create_video() -> dict:
    ...
    log(f"\nPOST {url}")
    log(f"  model={MODEL}  seconds={SECONDS}  resolution={RESOLUTION}")
