#!/usr/bin/env python3
"""Test Qwen HappyHorse 1.0 reference-to-video via the moretoken gateway.

This script uses the qwen input asset set under ../assets/input/qwen/.
"""
...
PROMPT = "以参考图片中的女生为唯一主体，严格保持人物身份、脸部特征、发型、白色衬衫、黑色背带和海边背景一致；视频动作、身体摆动节奏、手臂姿态、转身幅度和镜头运动风格参考动作视频，生成自然连贯的舞蹈短视频，人物清晰稳定，动作流畅，真实自拍视频质感。"
REFERENCE_IMAGE_SOURCE = "http://network.jancsitech.net:9000/video/qwen/reference_real_person.jpg"
SIZE = "720p"
SECONDS = 15
WATERMARK = True
SEED = None
...
OUTPUT_FILE = "../assets/output/qwen/output_qwen_happyhorse_1_0_r2v_qwen_input_set_15s.mp4"
...
def create_video() -> dict:
    ...
    image_value, image_label = resolve_media_input(REFERENCE_IMAGE_SOURCE, "image/png", "reference image")
