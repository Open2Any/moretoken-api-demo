#!/usr/bin/env python3
"""Test Qwen HappyHorse 1.0 image-to-video via the moretoken gateway."""

# ---- hardcoded config ----
API_KEY = "API_KEY"
BASE_URL = "https://napi.moretoken.ai"
MODEL = "happyhorse-1.0-i2v"
PROMPT = "基于参考图生成一段短视频：京剧人物缓慢回眸，眼神轻轻移动，水袖随风飘动，头饰珠光闪烁，暖金色舞台光缓慢流动，镜头轻微推进，电影感。"
IMAGE_SOURCE = "http://network.jancsitech.net:9000/video/image.png"
SIZE = "720p"
SECONDS = 15
WATERMARK = True
SEED = None
...
OUTPUT_FILE = "../assets/output/qwen/output_qwen_happyhorse_1_0_i2v_image_png_video_generation.mp4"
