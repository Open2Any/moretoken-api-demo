#!/usr/bin/env python3
"""Test Qwen HappyHorse 1.0 video-edit via the moretoken gateway."""

# ---- hardcoded config ----
API_KEY = "API_KEY"
BASE_URL = "https://napi.moretoken.ai"
MODEL = "happyhorse-1.0-video-edit"
PROMPT = "保持原视频主体、构图和动作节奏基本一致，增强画面清晰度与真实感，保留舞蹈动作连贯性，优化人物细节、光影层次和整体质感，生成自然稳定的短视频。"
VIDEO_SOURCE = "http://network.jancsitech.net:9000/video/qwen/blueprint-supreme-dance-tiktok_15s_540x720_15fps.mp4"
SIZE = "720p"
SECONDS = 15
WATERMARK = True
SEED = None
...
OUTPUT_FILE = "../assets/output/qwen/output_qwen_happyhorse_1_0_video_edit_video_generation_15s.mp4"
